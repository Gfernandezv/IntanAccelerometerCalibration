...
# estructura funciona prefenrentemente dentro de carpetas
output_files = [os.path.splitext(file)[0] + '.h5' for file in input_files]

# Iterate over pairs of input and output files and call convert function
for input_file, output_file in zip(input_files, output_files):
    convert([input_file], output_file)  # Note: convert function expects a list of filenames
